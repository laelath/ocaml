...
and type_declaration =
  { typ_id: Ident.t;
    typ_name: string loc;
    typ_params: (core_type * (variance * injectivity * contractivity)) list;
...
and type_extension =
  {
    ...
    tyext_params: (core_type * (variance * injectivity * contractivity)) list;
...
and 'a class_infos =
  { ci_virt: virtual_flag;
    ci_params: (core_type * (variance * injectivity * contractivity)) list;
